        ...
        <>
            <div className="main">
                ...
                <div className="searchBox">
                    ...
                    <button
            className="bg-red-950 text-white rounded-full px-4 py-2 ml-2 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-opacity-50"
